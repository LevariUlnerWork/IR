...
class Parse:
    ...
    def tokenize_words(self, text):
        ...
        shortscriptDict = {"⁰": "0", "¹": "1", "²": "2", "³": "3", "⁴": "4", "⁵": "5", "⁶": "6", "⁷": "7", "⁸": "8",
                           "⁹": "9",
                           "ᵃ": "a", "ᵇ": "b", "ᶜ": "c", "ᵈ": "d", "ᵉ": "e", "ᶠ": "f", "ᵍ": "g", "ʰ": "h", "ᶦ": "i",
                           "ʲ": "j",
                           "ᵏ": "k", "ˡ": "l", "ᵐ": "m", "ⁿ": "n", "ᵒ": "o", "ᵖ": "p", "۹": "q", "ʳ": "r", "ˢ": "s",
                           "ᵗ": "t",
        ...
        for wordIndex in range(0,len(listOfTokens)):
            ...
            if (wordToken == ',' or wordToken == '.' or wordToken == '/' or wordToken == '-' or wordToken == '_' or wordToken == '\t' or wordToken == '\n' \
